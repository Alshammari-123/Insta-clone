...
//                    Toast.makeText(this, "${dataSnapshot.ref.}", Toast.LENGTH_SHORT).show()
//                }
...
//                    // add to array list
//                    videoArrayList.add(modelVideo!!)
//                    Toast.makeText(this@VideosActivity, "Video array size: ${videoArrayList.size}", Toast.LENGTH_SHORT).show()
//                }
//                //setup adapter
//                adapterVideo = AdapterVideo(this@VideosActivity, videoArrayList)
//                var videoViewRv = findViewById<RecyclerView>(R.id.videoViewRv)
